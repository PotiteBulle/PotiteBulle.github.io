...
- Un identifiant de cas (ex : `CAS-2025-001`) ;
...
- Je sépare clairement :
  ...
  - Les contenus de <strong>preuve strictement nécessaires</strong> (à manipuler avec beaucoup de précautions dans un espaces déconnecté d'internet).
