...
On parle de <strong>violences sexuelles numériques</strong> lorsqu’une personne est exposée, menacée, humiliée ou contrôlée à travers des moyens numériques (internet, réseaux sociaux, messageries, jeux en ligne…), avec une dimension sexuelle ou sexuellement explicite, <strong>sans son consentement réel, libre et éclairé</strong>.
...
- Partage de nudes, sextapes, photos de webcam ou captures d’écran <strong>sans accord</strong> de la personne.
...
Ce type de comportement relève de la <strong>pédocriminalité</strong> et doit être signalé le plus vite possible aux plateformes et, selon le pays, aux services de police ou de signalement spécialisés.
...
<div class="note">
<strong>🔹 Sexualité consentie en ligne</strong> : échanges intimes entre personnes majeures, informées et d’accord, dans un cadre privé et respectueux.
</div>

<div class="note">
<strong>🔸 Violences sexuelles numériques</strong> : dès qu’il y a absence de consentement, pression, manipulation, chantage, exploitation d’un rapport de force, ou diffusion hors du cadre prévu.
</div><br>
...
Ce sont des infractions graves.</strong>

---

## 6. Si vous êtes concerné·e

Si vous êtes victime ou témoin de violences sexuelles numériques:

1. **Essayez de ne pas rester seul·e** : parlez-en à une personne de confiance si possible.  
2. **Conservez des preuves** (captures, liens, IDs, dates), sans les diffuser publiquement.  
3. **Utilisez les outils de signalement des plateformes** (par exemple, Trust & Safety, formulaires dédiés).  
4. **Renseignez-vous sur les dispositifs de votre pays** :  
   numéros d’écoute, plateformes de signalement, associations spécialisées.  
5. **Protégez votre sécurité d’abord** :  
   évitez de vous exposer davantage en allant “enquêter” seul·e dans des espaces hautement dangereux.
